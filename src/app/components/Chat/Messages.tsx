...
export default function Messages({
  ...
  return (
    <div className="border-2 border-gray-600 p-6 rounded-lg overflow-y-scroll flex-grow flex flex-col bg-iridium-chat">
      {messages.map((msg) => {
        return (
          <div
            key={msg.id}
            ...
            } my-2 p-3 rounded shadow-md hover:shadow-lg transition-shadow duration-200 flex slide-in-bottom bg-iridium border border-gray-600 message-glow`}
          >
            <div className="rounded-tl-lg bg-iridium p-2 border-r border-gray-600 flex items-center">
              {msg.role === 'assistant' ? '🤖' : '🧑‍💻'}
            </div>
